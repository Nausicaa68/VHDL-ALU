...
HD_PWD='C:/Users/utilisateur/Documents/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_PRJ_2021_TopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MCU_PRJ_2021_TopLevel.tcl -notrace
