...
HD_PWD='C:/Users/utilisateur/Documents/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_PRJ_2021_TopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_PRJ_2021_TopLevel.tcl
